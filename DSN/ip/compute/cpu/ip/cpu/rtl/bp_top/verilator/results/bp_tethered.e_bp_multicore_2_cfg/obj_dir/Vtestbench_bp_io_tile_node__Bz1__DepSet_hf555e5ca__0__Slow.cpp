...
VL_ATTR_COLD void Vtestbench_bp_io_tile_node__Bz1___stl_sequent__TOP__testbench__DOT__wrapper__DOT__processor__DOT__m__DOT__multicore__DOT__ic__DOT__node__BRA__0__KET____DOT__io__2(Vtestbench_bp_io_tile_node__Bz1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vtestbench_bp_io_tile_node__Bz1___stl_sequent__TOP__testbench__DOT__wrapper__DOT__processor__DOT__m__DOT__multicore__DOT__ic__DOT__node__BRA__0__KET____DOT__io__2\n"); );
    // Body
    vlSelf->io_tile__DOT__lce_cmd_wh_to_stream__DOT____Vcellinp__stream_control__link_accept_i 
        = ((IData)(vlSelf->io_tile__DOT____Vcellout__lce_cmd_wh_to_stream__link_ready_and_o) 
           & (vlSelf->__PVT__io_coh_socket__DOT__routers__BRA__0__KET____DOT__router->__PVT__link_o[4U] 
              >> 1U));
    if (vlSelf->__PVT__io_tile__DOT__lce_cmd_wh_to_stream__DOT__stream_control__DOT__state_r) {
        vlSelf->__PVT__io_tile__DOT__lce_cmd_v_li = 
            (1U & (vlSelf->__PVT__io_coh_socket__DOT__routers__BRA__0__KET____DOT__router->__PVT__link_o[4U] 
                   >> 1U));
        ...
        vlSelf->__PVT__io_tile__DOT__lce_cmd_v_li = 
            (1U & ((~ (0x810U >> (0xfU & (vlSelf->__PVT__io_tile__DOT__lce_cmd_wh_to_stream__DOT__hdr_sipo__DOT__fifos__BRA__0__KET____DOT__twofifo__DOT__fifo->data_o[0U] 
                                          >> 0xbU)))) 
    ...
    vlSelf->io_tile__DOT__lce_req_wh_to_stream__DOT____Vcellinp__stream_control__link_accept_i 
        = ((IData)(vlSelf->io_tile__DOT____Vcellout__lce_req_wh_to_stream__link_ready_and_o) 
           & (vlSelf->__PVT__io_coh_socket__DOT__routers__BRA__1__KET____DOT__router->__PVT__link_o[4U] 
              >> 1U));
    if (vlSelf->__PVT__io_tile__DOT__lce_req_wh_to_stream__DOT__stream_control__DOT__state_r) {
        vlSelf->__PVT__io_tile__DOT__lce_req_v_li = 
            (1U & (vlSelf->__PVT__io_coh_socket__DOT__routers__BRA__1__KET____DOT__router->__PVT__link_o[4U] 
                   >> 1U));
        ...
        vlSelf->__PVT__io_tile__DOT__lce_req_v_li = 
            (1U & ((~ (0x18U >> (0xfU & (vlSelf->__PVT__io_tile__DOT__lce_req_wh_to_stream__DOT__hdr_sipo__DOT__fifos__BRA__0__KET____DOT__twofifo__DOT__fifo->data_o[0U] 
                                         >> 0xbU)))) 
    ...
    vlSelf->io_tile__DOT__mem_rev_wormhole_to_stream__DOT____Vcellinp__stream_control__link_accept_i 
        = ((IData)(vlSelf->io_tile__DOT____Vcellout__mem_rev_wormhole_to_stream__link_ready_and_o) 
           & (vlSelf->__PVT__io_socket__DOT__routers__BRA__0__KET____DOT__router->__PVT__link_o[4U] 
              >> 1U));
    if (vlSelf->__PVT__io_tile__DOT__mem_rev_wormhole_to_stream__DOT__stream_control__DOT__state_r) {
        vlSelf->__PVT__io_tile__DOT__mem_rev_v_li = 
            (1U & (vlSelf->__PVT__io_socket__DOT__routers__BRA__0__KET____DOT__router->__PVT__link_o[4U] 
                   >> 1U));
        ...
        vlSelf->__PVT__io_tile__DOT__mem_rev_v_li = 
            (1U & ((~ (5U >> (0xfU & (vlSelf->__PVT__io_tile__DOT__mem_rev_wormhole_to_stream__DOT__hdr_sipo__DOT__fifos__BRA__0__KET____DOT__twofifo__DOT__fifo->data_o[0U] 
                                      >> 0xaU)))) & 
...
VL_ATTR_COLD void Vtestbench_bp_io_tile_node__Bz1___stl_sequent__TOP__testbench__DOT__wrapper__DOT__processor__DOT__m__DOT__multicore__DOT__ic__DOT__node__BRA__1__KET____DOT__io__2(Vtestbench_bp_io_tile_node__Bz1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vtestbench_bp_io_tile_node__Bz1___stl_sequent__TOP__testbench__DOT__wrapper__DOT__processor__DOT__m__DOT__multicore__DOT__ic__DOT__node__BRA__1__KET____DOT__io__2\n"); );
    // Body
    vlSelf->io_tile__DOT__lce_cmd_wh_to_stream__DOT____Vcellinp__stream_control__link_accept_i 
        = ((IData)(vlSelf->io_tile__DOT____Vcellout__lce_cmd_wh_to_stream__link_ready_and_o) 
           & (vlSelf->__PVT__io_coh_socket__DOT__routers__BRA__0__KET____DOT__router->__PVT__link_o[4U] 

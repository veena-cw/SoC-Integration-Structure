...
#ifndef VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_IN__PI74_H_
#define VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_IN__PI74_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtestbench_bp_me_stream_pump_in__pi74 final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __VdfgExtracted_h5933db0c__3;
    ...
    VL_INW(__PVT__msg_header_i,65,0,3);
    VL_INW(__PVT__msg_data_i,127,0,4);
    VL_OUTW(__PVT__fsm_header_o,65,0,3);
    ...
    // CONSTRUCTORS
    Vtestbench_bp_me_stream_pump_in__pi74(Vtestbench__Syms* symsp, const char* v__name);
    ~Vtestbench_bp_me_stream_pump_in__pi74();
    VL_UNCOPYABLE(Vtestbench_bp_me_stream_pump_in__pi74);

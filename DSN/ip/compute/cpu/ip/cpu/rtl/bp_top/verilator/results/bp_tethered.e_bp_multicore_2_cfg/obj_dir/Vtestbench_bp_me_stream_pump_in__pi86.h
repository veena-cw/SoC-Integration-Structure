...
#ifndef VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_IN__PI86_H_
#define VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_IN__PI86_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtestbench_bp_me_stream_pump_in__pi86 final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __VdfgExtracted_h5933db0c__4;
    ...
    // CONSTRUCTORS
    Vtestbench_bp_me_stream_pump_in__pi86(Vtestbench__Syms* symsp, const char* v__name);
    ~Vtestbench_bp_me_stream_pump_in__pi86();
    VL_UNCOPYABLE(Vtestbench_bp_me_stream_pump_in__pi86);

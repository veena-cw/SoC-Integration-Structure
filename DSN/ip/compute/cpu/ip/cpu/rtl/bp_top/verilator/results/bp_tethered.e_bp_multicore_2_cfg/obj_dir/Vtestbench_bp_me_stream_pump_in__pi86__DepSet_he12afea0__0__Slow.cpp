...
VL_ATTR_COLD void Vtestbench_bp_me_stream_pump_in__pi86___ctor_var_reset(Vtestbench_bp_me_stream_pump_in__pi86* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                            Vtestbench_bp_me_stream_pump_in__pi86___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__VdfgExtracted_h5933db0c__4 = 0;

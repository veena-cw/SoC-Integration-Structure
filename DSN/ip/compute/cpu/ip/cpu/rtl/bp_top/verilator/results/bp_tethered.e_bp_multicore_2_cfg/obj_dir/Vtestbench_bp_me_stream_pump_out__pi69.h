...
#ifndef VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_OUT__PI69_H_
#define VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_OUT__PI69_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtestbench_bp_me_stream_pump_out__pi69 final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __VdfgExtracted_hd82698c1__0;
    ...
    VL_OUT64(__PVT__msg_header_o,63,0);
    VL_IN64(__PVT__fsm_header_i,63,0);
    ...
    // CONSTRUCTORS
    Vtestbench_bp_me_stream_pump_out__pi69(Vtestbench__Syms* symsp, const char* v__name);
    ~Vtestbench_bp_me_stream_pump_out__pi69();
    VL_UNCOPYABLE(Vtestbench_bp_me_stream_pump_out__pi69);

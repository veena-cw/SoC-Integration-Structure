...
#ifndef VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_OUT__PI73_H_
#define VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_OUT__PI73_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtestbench_bp_me_stream_pump_out__pi73 final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __VdfgExtracted_hd82698c1__2;
    ...
    VL_OUTW(__PVT__msg_header_o,65,0,3);
    VL_OUTW(__PVT__msg_data_o,127,0,4);
    VL_INW(__PVT__fsm_header_i,65,0,3);
    VL_INW(__PVT__fsm_data_i,127,0,4);
    VlWide<7>/*193:0*/ gearbox__DOT____Vcellout__fifo__data_o;
    ...
    VlUnpacked<VlWide<7>/*193:0*/, 2> __PVT__gearbox__DOT__fifo__DOT__mem_1r1w__DOT__synth__DOT__nz__DOT__mem;
    ...
    // CONSTRUCTORS
    Vtestbench_bp_me_stream_pump_out__pi73(Vtestbench__Syms* symsp, const char* v__name);
    ~Vtestbench_bp_me_stream_pump_out__pi73();
    VL_UNCOPYABLE(Vtestbench_bp_me_stream_pump_out__pi73);

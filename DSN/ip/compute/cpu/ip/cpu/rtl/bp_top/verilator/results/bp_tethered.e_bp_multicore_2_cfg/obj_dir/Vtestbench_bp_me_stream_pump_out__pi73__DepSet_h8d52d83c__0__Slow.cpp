...
VL_ATTR_COLD void Vtestbench_bp_me_stream_pump_out__pi73___ctor_var_reset(Vtestbench_bp_me_stream_pump_out__pi73* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                            Vtestbench_bp_me_stream_pump_out__pi73___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__VdfgExtracted_hd82698c1__2 = 0;

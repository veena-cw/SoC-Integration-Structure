...
#ifndef VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_OUT__PI75_H_
#define VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_OUT__PI75_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtestbench_bp_me_stream_pump_out__pi75 final : public VerilatedModule {
  public:
    ...
    VL_IN8(__PVT__fsm_v_i,0,0);
    VL_OUT8(__PVT__fsm_ready_then_o,0,0);
    VL_OUT8(__PVT__fsm_new_o,0,0);
    VL_OUT8(__PVT__fsm_last_o,0,0);
    VL_OUT8(__PVT__fsm_critical_o,0,0);
    CData/*0:0*/ __PVT__msg_v_lo;
    CData/*1:0*/ __PVT__stream_size;
    CData/*0:0*/ __PVT__cnt_up;
    CData/*0:0*/ __VdfgExtracted_hd82698c1__3;
    ...
    VL_INW(__PVT__fsm_header_i,74,0,3);
    VL_INW(__PVT__fsm_data_i,127,0,4);
    VlWide<7>/*202:0*/ gearbox__DOT____Vcellout__fifo__data_o;
    ...
    VlUnpacked<VlWide<7>/*202:0*/, 2> __PVT__gearbox__DOT__fifo__DOT__mem_1r1w__DOT__synth__DOT__nz__DOT__mem;
    ...
    // CONSTRUCTORS
    Vtestbench_bp_me_stream_pump_out__pi75(Vtestbench__Syms* symsp, const char* v__name);
    ~Vtestbench_bp_me_stream_pump_out__pi75();
    VL_UNCOPYABLE(Vtestbench_bp_me_stream_pump_out__pi75);

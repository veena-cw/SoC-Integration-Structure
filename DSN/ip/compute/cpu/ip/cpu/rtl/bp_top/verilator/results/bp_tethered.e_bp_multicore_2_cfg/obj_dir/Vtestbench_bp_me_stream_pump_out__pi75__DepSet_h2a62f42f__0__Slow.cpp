...
VL_ATTR_COLD void Vtestbench_bp_me_stream_pump_out__pi75___ctor_var_reset(Vtestbench_bp_me_stream_pump_out__pi75* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                            Vtestbench_bp_me_stream_pump_out__pi75___ctor_var_reset\n"); );
    // Body
    ...
    VL_ZERO_RESET_W(75, vlSelf->__PVT__fsm_header_i);
    ...
    vlSelf->__VdfgExtracted_hd82698c1__3 = 0;

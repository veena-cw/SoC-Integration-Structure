...
#ifndef VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_OUT__PI87_H_
#define VERILATED_VTESTBENCH_BP_ME_STREAM_PUMP_OUT__PI87_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtestbench_bp_me_stream_pump_out__pi87 final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __VdfgExtracted_hd82698c1__4;
    ...
    // CONSTRUCTORS
    Vtestbench_bp_me_stream_pump_out__pi87(Vtestbench__Syms* symsp, const char* v__name);
    ~Vtestbench_bp_me_stream_pump_out__pi87();
    VL_UNCOPYABLE(Vtestbench_bp_me_stream_pump_out__pi87);

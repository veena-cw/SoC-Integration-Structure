...
VL_ATTR_COLD void Vtestbench_bp_me_stream_pump_out__pi87___ctor_var_reset(Vtestbench_bp_me_stream_pump_out__pi87* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                            Vtestbench_bp_me_stream_pump_out__pi87___ctor_var_reset\n"); );
    // Body
    vlSelf->__PVT__clk_i = 0;
    vlSelf->__PVT__reset_i = 0;
    VL_ZERO_RESET_W(66, vlSelf->__PVT__msg_header_o);
    VL_ZERO_RESET_W(128, vlSelf->__PVT__msg_data_o);
    vlSelf->__PVT__msg_v_o = 0;
    vlSelf->__PVT__msg_ready_and_i = 0;
    VL_ZERO_RESET_W(66, vlSelf->__PVT__fsm_header_i);
    ...
    vlSelf->__VdfgExtracted_hd82698c1__4 = 0;

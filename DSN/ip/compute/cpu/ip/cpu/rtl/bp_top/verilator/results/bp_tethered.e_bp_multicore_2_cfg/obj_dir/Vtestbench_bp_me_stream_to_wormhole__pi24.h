...
#ifndef VERILATED_VTESTBENCH_BP_ME_STREAM_TO_WORMHOLE__PI24_H_
#define VERILATED_VTESTBENCH_BP_ME_STREAM_TO_WORMHOLE__PI24_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtestbench_bp_me_stream_to_wormhole__pi24 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vtestbench_bp_me_stream_to_wormhole__pi24(Vtestbench__Syms* symsp, const char* v__name);
    ~Vtestbench_bp_me_stream_to_wormhole__pi24();
    VL_UNCOPYABLE(Vtestbench_bp_me_stream_to_wormhole__pi24);

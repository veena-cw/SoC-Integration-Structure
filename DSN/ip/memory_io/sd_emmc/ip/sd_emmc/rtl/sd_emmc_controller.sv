...
`include "sd_emmc_defines.h"
        ...
        output logic [7:0] sd_dat_o,
        input logic [7:0] sd_dat_i,
    ...
    logic go_idle;
    logic cmd_start_axi_clk;
    logic cmd_start_sd_clk;
    logic cmd_start;
    ...
    logic data_start_rx;
    logic data_start_tx;
    logic cmd_int_rst_axi_clk;
    logic cmd_int_rst_sd_clk;
    logic cmd_int_rst;
    logic data_int_rst_axi_clk;
    logic data_int_rst_sd_clk;
    logic data_int_rst;

    //wb accessible logicisters
    logic [31:0] argument_axi_clk;
    logic [`CMD_REG_SIZE-1:0] command_axi_clk;
    logic [`DATA_TIMEOUT_W-1:0] data_timeout_axi_clk;
    logic [1:0] software_reset_axi_clk;
    logic [31:0] response_0_axi_clk;
    logic [31:0] response_1_axi_clk;
    logic [31:0] response_2_axi_clk;
    logic [31:0] response_3_axi_clk;
    logic [`BLKSIZE_W-1:0] block_size_axi_clk;
    logic controll_setting_axi_clk;
    logic controll_setting_8bit_axi_clk;
    logic [`INT_CMD_SIZE-1:0] cmd_int_status_axi_clk;
    logic [`INT_DATA_SIZE-1:0] data_int_status_axi_clk;
    logic [`BLKCNT_W-1:0] block_count_axi_clk;

    logic [31:0] argument_sd_clk;
    logic [`CMD_REG_SIZE-1:0] command_sd_clk;
    logic [`DATA_TIMEOUT_W-1:0] data_timeout_sd_clk;
    logic [31:0] response_0_sd_clk;
    logic [31:0] response_1_sd_clk;
    logic [31:0] response_2_sd_clk;
    logic [31:0] response_3_sd_clk;
    logic [`BLKSIZE_W-1:0] block_size_sd_clk;
    logic controll_setting_sd_clk;
    logic controll_setting_8bit_sd_clk;
    logic [`INT_CMD_SIZE-1:0] cmd_int_status_sd_clk;
    logic [`INT_DATA_SIZE-1:0] data_int_status_sd_clk;
    logic [`BLKCNT_W-1:0] block_count_sd_clk;
    
    //Software Reset
    logic soft_rst_cmd_axi_clk;
    logic soft_rst_dat_axi_clk;
    logic soft_rst_cmd_sd_clk;
    logic soft_rst_dat_sd_clk;
    logic next_block_st;
    logic next_block_st_axi;
    logic fifo_reset;
    
    //Interrupts
    logic [28:0] int_status_logic;
    logic [28:0] int_status_en_logic;
    logic [28:0] int_signal_en_logic;

    // Present state logicister
    logic rd_trans_act_axi_clk;
    logic rd_trans_act_sd_clk;
    logic wr_trans_act_axi_clk;
    logic wr_trans_act_sd_clk;
    logic command_inhibit_dat_axi_clk;
    logic data_line_active_axi_clk;
    logic command_inhibit_cmd_sd_clk;
    logic command_inhibit_cmd_axi_clk;
    
    // Transfer mode logicister
    logic dat_trans_dir_axi_clk;
    logic dat_trans_dir_sd_clk;
    logic [31:0] read_fifo_out;
    logic        fifo_data_read_ready;
    logic        fifo_data_write_ready;
    
    // data write to SD card
    logic start_tx;
    logic start_write_sd_clk;

    // dma
    logic [31:0] system_addr;
    logic [1:0] dma_and_blkcnt_en;
    logic [1:0] dma_int;
    logic cmd_cmplt_axi_puls;
    logic stop_blk_gap_req;
    
    // data aligning
    logic [31:0] write_dat_fifo;
    assign write_dat_fifo = {M_AXI_RDATA[7:0],M_AXI_RDATA[15:8],M_AXI_RDATA[23:16],M_AXI_RDATA[31:24]};
    
    // UHS mode
    logic [2:0] UHSModSel_axi_clk;
    logic [2:0] UHSModSel_sd_clk;
    logic sd_clk90;
        ...
        sd_emmc_controller_S00_AXI # ( 
            ...
            .int_stat_o(int_status_logic),
            .int_stat_en_o(int_status_en_logic),
            .int_sig_en_o(int_signal_en_logic),
    ...
    bistable_domain_cross #(32) argument_logic_cross(!s00_axi_aresetn, s00_axi_aclk, argument_axi_clk, SD_CLK, argument_sd_clk);
    bistable_domain_cross #(`CMD_REG_SIZE) command_logic_cross(!s00_axi_aresetn, s00_axi_aclk, command_axi_clk, SD_CLK, command_sd_clk);
    bistable_domain_cross #(32) response_0_logic_cross(!s00_axi_aresetn, SD_CLK, response_0_sd_clk, s00_axi_aclk, response_0_axi_clk);
    bistable_domain_cross #(32) response_1_logic_cross(!s00_axi_aresetn, SD_CLK, response_1_sd_clk, s00_axi_aclk, response_1_axi_clk);
    bistable_domain_cross #(32) response_2_logic_cross(!s00_axi_aresetn, SD_CLK, response_2_sd_clk, s00_axi_aclk, response_2_axi_clk);
    bistable_domain_cross #(32) response_3_logic_cross(!s00_axi_aresetn, SD_CLK, response_3_sd_clk, s00_axi_aclk, response_3_axi_clk);
    bistable_domain_cross #(`DATA_TIMEOUT_W) data_timeout_logic_cross(!s00_axi_aresetn, s00_axi_aclk, data_timeout_axi_clk, SD_CLK, data_timeout_sd_clk);
    ...
    bistable_domain_cross #(`BLKCNT_W) block_count_logic_cross(!s00_axi_aresetn, s00_axi_aclk, block_count_axi_clk, SD_CLK, block_count_sd_clk);
    bistable_domain_cross #(`INT_DATA_SIZE) data_int_status_logic_cross(!s00_axi_aresetn, SD_CLK, data_int_status_sd_clk, s00_axi_aclk, data_int_status_axi_clk);
    bistable_domain_cross #(3) UHSModSel_cross(!s00_axi_aresetn, s00_axi_aclk, UHSModSel_axi_clk, SD_CLK, UHSModSel_sd_clk);
    
    assign interrupt = |(int_status_logic & int_status_en_logic & int_signal_en_logic);

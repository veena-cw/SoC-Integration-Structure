class axi_mem_sequencer extends uvm_sequencer #(axi_mem_item);  // Declares this UVM testbench class.
    `uvm_component_utils(axi_mem_sequencer)  // Registers this component type with the UVM factory.

class axil_sequencer extends uvm_sequencer #(axil_item);  // Declares this UVM testbench class.
    `uvm_component_utils(axil_sequencer)  // Registers this component type with the UVM factory.

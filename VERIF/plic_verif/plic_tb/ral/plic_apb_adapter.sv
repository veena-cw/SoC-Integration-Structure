...
// Generated APB Adapter for RoaLogic_PLIC
// IP: PLIC
// Converts uvm_reg_bus_op <-> APB transaction (no timing)

package plic_apb_adapter_pkg;
  import uvm_pkg::*;
  `include "uvm_macros.svh"
  import plic_ral_pkg::*;
  import plic_apb_item_pkg::*;

  class plic_apb_adapter extends uvm_reg_adapter;
    `uvm_object_utils(plic_apb_adapter)
    function new(string name = "plic_apb_adapter");
      super.new(name);
    ...
    virtual function uvm_sequence_item reg2bus(const ref uvm_reg_bus_op rw);
      plic_apb_item item;
      item = plic_apb_item::type_id::create("item");
      item.paddr  = rw.addr;

class spi_m1_full_duplex_msb extends spi_base_test;

    `uvm_component_utils(spi_m1_full_duplex_msb)

    function new(string name = "spi_m1_full_duplex_msb",
    ...
    task run_phase(uvm_phase phase);
      ...
      `uvm_info("TEST",
        "Starting spi_m1_full_duplex_msb: Master TX=A5, Slave TX=3C, Mode1",
        UVM_LOW)

class spi_m2_full_duplex_msb extends spi_base_test;

    `uvm_component_utils(spi_m2_full_duplex_msb)

    function new(string name = "spi_m2_full_duplex_msb",
    ...
    task run_phase(uvm_phase phase);
      ...
      `uvm_info("TEST",
        "Starting spi_m2_full_duplex_msb: Master TX=A5, Slave TX=3C, Mode2",
        UVM_LOW)
